...
public class TowerActionHandler : MonoBehaviour
{
    ...
    public void PrepareGame(InputButtonHandler iBH, RaycastHandler rH)
    {
        LoadComponents(iBH, rH);
        RegisterInputControllerEvent();
        RegisterRaycastHandlerEvent();
        audioSource = GetComponent<AudioSource>();
    }

    private void LoadComponents(InputButtonHandler iBH, RaycastHandler rH)
    {
    ...
    private void HandleUpgradeTowerBtnClick(Button clickedButton)
    {
        if (currentButton != clickedButton)
        {
            AudioManager.Instance.PlaySound(soundEffectSO.clickSound);
    ...
    #region SELL
    private void HandleSellTowerBtnClick(Button clickedButton)
    {
        if(currentButton != clickedButton)
        {
            AudioManager.Instance.PlaySound(soundEffectSO.clickSound);
