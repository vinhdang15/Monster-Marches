...
public class ParabolBullet : BulletBase
{
    ...
    {
        float X = targetEnemy.transform.position.x - instantiatePoint.x;
        float Y = targetEnemy.transform.position.y - instantiatePoint.y;
    ...
    public override IEnumerator MoveToTargetCoroutine()
    {
        ...
        {  
            ...
            {
                Debug.Log(Vector2.Distance(transform.position, enemyPos));
