...
public class JSONCreator : MonoBehaviour
{
    ...
    [SerializeField] MapObjDataProcessor mapObjDataProc;
    ...
    {
        List<MapObjData> mapObjDatas = mapObjDataProc.ExtractMapObjData();
        JSONManager.SaveMapObjDataToJson(mapObjDatas);
    }
